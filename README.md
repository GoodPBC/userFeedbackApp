...
12. __Saving information to our DB__ Okay so we need a way to save a user to our database so that we store the users id and give them a cookie to come back to our site. We do this by requiring mongoose and our User model into our passport.js file. 
